...
func (w *Window) setDefaultTheme() {
	...
	s.SetColor(imgui.StyleColorHeaderHovered, imgui.Vec4{X: 0.36, Y: 0.41, Z: 0.44, W: 1.00})
	s.SetColor(imgui.StyleColorHeaderActive, imgui.Vec4{X: 0.18, Y: 0.21, Z: 0.22, W: 1.00})
