...
class ColorExtractor {
    companion object {
        ...
        fun extract(color: String?, alpha: Int): Color {
            if (color == null) {
                return defaultColor
            }
            ...
            if (alphaValue == 1f && awtColor == null) {
                return defaultColor
            }

            return if (awtColor != null) {
                Color(awtColor.red / 255f, awtColor.green / 255f, awtColor.blue / 255f, alphaValue)
            } else {
                Color(1f, 1f, 1f, alphaValue)
            }
        }
